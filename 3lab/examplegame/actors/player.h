...
namespace lab3 {
  ...
  private:
    ...
    Inputer::validation_result_t validate_command_wait(const Inputer::command_t& command) const;
    ...
    void evaluate_command_wait(Game& game, const Inputer::command_t& last_command);
